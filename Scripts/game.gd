...
func _on_player_died():
	...
	if lives <= 0:
		...
		# Oyun bittiğinde AsteroidSpawner'ı kaldır
		var spawner = get_node("AsteroidSpawner")  # Eğer Game node'unun altındaysa
		if spawner:
			spawner.queue_free()  # Spawner'ı sahneden kaldır
